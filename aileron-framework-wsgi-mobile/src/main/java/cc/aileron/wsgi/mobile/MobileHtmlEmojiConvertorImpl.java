...
public class MobileHtmlEmojiConvertorImpl implements MobileHtmlEmojiConvertor
{
     ...
     */
    @Inject
    public MobileHtmlEmojiConvertorImpl() throws ResourceNotFoundException,
            XPathExpressionException, FileSystemException
    {
        final XPath xpath = XPathFactory.newInstance().newXPath();
        final String expression = "//e";
        final InputSource inputSource = new InputSource(ResourceUtils.resource("emoji4unicode.xml")
                .toFileContent()
                .getInputStream());
